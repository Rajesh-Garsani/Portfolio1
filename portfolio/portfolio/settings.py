...
# For local development, we'll use a default key
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-local-dev-key-12345')

# SECURITY WARNING: don't run with debug turned on in production!
# For local development, we'll set DEBUG to True
DEBUG = False

# For local development, allow all hosts
ALLOWED_HOSTS = ['rajeshgarsani.pythonanywhere.com']
...
# Use console backend to view emails in terminal
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'rkbscs153@gmail.com'
DEFAULT_FROM_EMAIL = 'rkbscs153@gmail.com'
ADMIN_EMAIL = 'rkbscs153@gmail.com'

# For production, we'll use environment variables
# But for local development, we'll keep it simple
